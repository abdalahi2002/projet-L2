...
<style>
    ...
    --first-color-light: #AFA5D9;--white-color: #F7F6FB;
    --body-font: 'Nunito', sans-serif;--normal-font-size: 1rem;
    --z-fixed: 100}*,::before,::after{box-sizing: border-box}
    body{position: relative;
    margin: var(--header-height) 0 0 0;padding: 0 1rem;font-family: var(--body-font);font-size: var(--normal-font-size);transition: .5s}
    ...
    .header_img{width: 200px;height: 70px}
    .header_img img{width: 200px}
...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <div class="bc"><img class="rounded-circle mt-4" width="100px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><br><span class="font-weight-bold">{{Auth::user()->name.' '.Auth::user()->prenom}}</span><br><span class="text-green-50">{{Auth::user()->email}}</span><span> </span></div>
                <div class="nav_list">
                    <a href="{{route('accueil')}}" class="nav_link ><i class="fa-solid fa-house"></i><span class="nav_name">Accuiel</span> </a>
                    <a href="{{route('benevole.index')}}" class="nav_link "><i class="fa-solid fa-people-group"></i> <span class="nav_name">Bénévoles</span> </a>
                    <a href="{{route('necessiteux.index')}}" class="nav_link "> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Necessiteux</span> </a>
                    <a href="{{ route('user.index') }}" class="nav_link active"><i class="fa-solid fa-users"></i><span class="nav_name">Employés</span> </a>

                    <a href="{{route('don.index')}}" class="nav_link"><i class="fa-solid fa-hand-holding-heart"></i><span class="nav_name">Don</span> </a>
