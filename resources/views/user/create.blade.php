            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="metier" class="col-md-4 col-form-label text-md-end">{{ __('Specialite') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="user" class="col-md-4 col-form-label text-md-end">{{ __('Utilisateur') }}</label>

                            <div class="col-md-6">
                                <input id="utili" type="text" class="form-control @error('utili') is-invalid @enderror" name="utili" value="{{ old('user') }}" required autocomplete="utili" autofocus>
