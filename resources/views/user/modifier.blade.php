                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update', $user->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="metier" type="text" class="form-control @error('metier') is-invalid @enderror" name="metier" value="{{ $user->metier}}" required autocomplete="metier" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" value="{{$user->password_confirm}}" required autocomplete="new-password">
                            </div>
                        </div>
